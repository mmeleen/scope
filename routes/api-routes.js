...
module.exports = function(app) {
  ...
  app.post('/api/saveSearch', function(req, res) {
    ...
    var reqDescription = req.description;
    var reqMood = req.description;
    var reqColor = req.color;
    var reqLucky_number = req.lucky_number;
    var reqLucky_time = req.lucky_time;
